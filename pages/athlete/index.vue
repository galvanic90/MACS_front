...
<template>
    ...
    <div v-else>
        <v-data-table :items="data" item-key="id" items-per-page="10" :headers="headers" :loading=isPending()>
            <template v-slot:top>
                <v-toolbar flat>
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                <v-container>
                                    ...
                                    <v-select label="Tipo de documento" :items="documentTypes" item-title="name"
                                        item-value="id" v-model="editedItem.documentTypeId"></v-select>
                                    <v-text-field v-model="editedItem.idNumber"
                                    ...
                                    <v-date-input label="Fecha de nacimiento"
                                        v-model="editedItem.birthDate"></v-date-input>
                                </v-container>
                            </v-card-text>
